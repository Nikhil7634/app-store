...
// Fetch existing service data if an ID is provided for editing
if (isset($_GET['id'])) {
    $serviceId = $_GET['id'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $imagePath = $service['image_path']; // Retain the existing image if not updated
    ...
    $sql = "UPDATE blogs SET title = :title, description = :description, image_path = :image_path WHERE id = :id";
    $stmt = $dbh->prepare($sql);
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="grid grid-cols-12 gap-x-4">
            <div class="col-span-full lg:col-span-7 card">
                <div class="p-1.5">
                    <h6 class="card-title">Edit blog Details</h6>
                    ...
                    <div class="mt-7 pt-0.5">
                        <div class="grid grid-cols-full gap-x-4 gap-y-5">
                            <div class="col-span-full xl:col-auto leading-none">
                                ...
                                <input type="text" id="courseTitle" name="title" value="<?php echo htmlspecialchars($service['title']); ?>" placeholder="Title" class="form-input" required>
                            </div>
                            ...
                            <div class="col-span-full">
                                ...
                                <textarea id="description" name="description" rows="8" class="summernote form-input" required><?php echo htmlspecialchars($service['description']); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
